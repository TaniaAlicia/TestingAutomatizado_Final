...
public class BasePage {
    ...
    /** Método para ingresar un numero en el elemento especificado.*/
    protected void sendNumber(double inputNumber, By locator) throws InterruptedException {
        wait.until(ExpectedConditions.presenceOfElementLocated(locator));
        String numberAsString = String.valueOf(inputNumber);
        this.findElement(locator).clear();
        this.findElement(locator).sendKeys(numberAsString);
    }
